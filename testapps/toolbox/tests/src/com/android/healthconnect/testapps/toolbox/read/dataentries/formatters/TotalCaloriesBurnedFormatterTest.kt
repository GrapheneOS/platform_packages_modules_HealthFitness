...
class TotalCaloriesBurnedFormatterTest {
    private val formatter = TotalCaloriesBurnedFormatter()
    private val context: Context = ApplicationProvider.getApplicationContext()

    @Test
    fun formatTotalCaloriesBurnedValue_returnedFormattedEntry() {
        val record = getTotalCaloriesBurnedRecord(22000.0)

        val formattedEntry = formatter.format(record, context)

        assertThat(formattedEntry.value).isEqualTo("22 cal")
    }
