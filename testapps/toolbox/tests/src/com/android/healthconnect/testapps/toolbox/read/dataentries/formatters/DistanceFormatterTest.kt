...
class DistanceFormatterTest {
    ...
    @Test
    fun formatDistanceValue_returnedFormattedEntry_km() {
        val record = getDistanceRecord(1230.0)

        val formattedEntry = formatter.format(record, context)

        assertThat(formattedEntry.value).isEqualTo("1.23 km")
    }

    private fun getDistanceRecord(distance: Double): DistanceRecord {
