...
class ActiveCaloriesBurnedFormatterTest {
    ...
    private val formatter = ActiveCaloriesBurnedFormatter()
    private val context: Context = ApplicationProvider.getApplicationContext()

    @Test
    fun formatActiveCaloriesBurnedValue_returnedFormattedEnergy_cal() {
        val record = getActiveCaloriesBurnedRecord(5000.0)

        val formattedEnergy = formatter.format(record, context)

        assertThat(formattedEnergy.value).isEqualTo("5 cal")
    }
