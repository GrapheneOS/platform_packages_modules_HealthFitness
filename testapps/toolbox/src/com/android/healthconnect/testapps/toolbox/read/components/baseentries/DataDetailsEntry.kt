...
@Composable
fun DataDetailsEntry(dataEntryDetails: FormattedDataDetails) {
    ...
    Column {
        ...
        Row(
            ...
            DataEntry(dataEntry = dataEntryDetails.dataEntry)
            Icon(
        ...
        AnimatedVisibility(visible = dropDownExpanded) {
            Column(modifier = Modifier.padding(start = PADDING_LARGE)) {
                dataEntryDetails.dataDetails.forEach { entryDetail ->
