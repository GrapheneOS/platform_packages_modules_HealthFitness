...
public final class HealthPermissions {
    ...
    public static boolean isPermissionEnabled(@NonNull String permission) {
        ...
        // For Fitness and Medical Record read/write permissions, flags are checked within these
        // methods.
        if (mappings.isFitnessPermission(permission)
                || getAllMedicalPermissions().contains(permission)) {
            return true;
        }
        return switch (permission) {
            case READ_HEALTH_DATA_HISTORY,
