...
public class SymptomRecordInternalTest {
    ...
    public void toExternalRecord_allFieldsSet() {
        ...
        SymptomRecordInternal internalRecord =
                (SymptomRecordInternal)
                        new SymptomRecordInternal()
                                ...
                                .setCount(2)
                                .setTemporalType(SymptomRecord.RECORD_TEMPORAL_TYPE_INTERVAL)
        ...
        SymptomRecord externalRecord = internalRecord.toExternalRecord();

        Metadata metadata = externalRecord.getMetadata();
        assertThat(externalRecord.getRecordType()).isEqualTo(RECORD_TYPE_SYMPTOM);
        assertThat(externalRecord.getSymptomType()).isEqualTo(SYMPTOM_TYPE_COUGH);
        assertThat(externalRecord.getNotes()).isEqualTo("notes");
        assertThat(externalRecord.getSeverity()).isEqualTo(SymptomRecord.SEVERITY_MILD);
        assertThat(externalRecord.getCount()).isEqualTo(2);
        assertThat(externalRecord.getTemporalType())
                .isEqualTo(SymptomRecord.RECORD_TEMPORAL_TYPE_INTERVAL);
    ...
    public void toExternalRecord_optionalFieldsNotSet() {
        ...
        SymptomRecordInternal internalRecord =
                (SymptomRecordInternal)
                        new SymptomRecordInternal().setPackageName("package.name").setUuid(uuid);

        SymptomRecord externalRecord = internalRecord.toExternalRecord();

        Metadata metadata = externalRecord.getMetadata();
        assertThat(externalRecord.getRecordType()).isEqualTo(RECORD_TYPE_SYMPTOM);
        assertThat(externalRecord.getSymptomType()).isEqualTo(SYMPTOM_TYPE_UNKNOWN);
        assertThat(externalRecord.getNotes()).isEqualTo(null);
        assertThat(externalRecord.getSeverity()).isEqualTo(SymptomRecord.SEVERITY_UNSPECIFIED);
        assertThat(externalRecord.getCount()).isEqualTo(1);
        assertThat(externalRecord.getTemporalType())
                .isEqualTo(SymptomRecord.RECORD_TEMPORAL_TYPE_INSTANT);
    ...
    public void writeToParcel_populateUsing_allFieldsSet() {
        ...
        SymptomRecordInternal internalRecord =
                (SymptomRecordInternal)
                        new SymptomRecordInternal()
                                ...
                                .setTemporalType(SymptomRecord.RECORD_TEMPORAL_TYPE_INSTANT)
                                .setStartTime(1357924680)
                                .setEndTime(2468013579L)
                                .setStartZoneOffset(-2 * 3600)
                                .setEndZoneOffset(3 * 3600)
        ...
        SymptomRecordInternal decodedRecord = new SymptomRecordInternal(parcel);
        parcel.recycle();

        assertThat(decodedRecord.getSymptomType()).isEqualTo(SYMPTOM_TYPE_COUGH);
        assertThat(decodedRecord.getNotes()).isEqualTo("notes");
        assertThat(decodedRecord.getSeverity()).isEqualTo(SymptomRecord.SEVERITY_MODERATE);
        assertThat(decodedRecord.getCount()).isEqualTo(1);
        assertThat(decodedRecord.getTemporalType())
                .isEqualTo(SymptomRecord.RECORD_TEMPORAL_TYPE_INSTANT);
    ...
    public void writeToParcel_populateUsing_optionalFieldsNotSet() {
        ...
        assertThat(decodedRecord.getSymptomType()).isEqualTo(SYMPTOM_TYPE_UNKNOWN);
        assertThat(decodedRecord.getNotes()).isEqualTo(null);
        assertThat(decodedRecord.getSeverity()).isEqualTo(SymptomRecord.SEVERITY_UNSPECIFIED);
        assertThat(decodedRecord.getCount()).isEqualTo(1);
        assertThat(decodedRecord.getTemporalType())
                .isEqualTo(SymptomRecord.RECORD_TEMPORAL_TYPE_INSTANT);
    ...
    @Test
    public void symptomRecord_toInternalRecord_allFieldsSet() {
        UUID uuid = UUID.randomUUID();
        Metadata metadata =
        ...
        SymptomRecordInternal internalRecord = externalRecord.toRecordInternal();

        assertThat(internalRecord.getSymptomType()).isEqualTo(SYMPTOM_TYPE_COUGH);
        assertThat(internalRecord.getNotes()).isEqualTo("notes");
        assertThat(internalRecord.getSeverity()).isEqualTo(SymptomRecord.SEVERITY_SEVERE);
        assertThat(internalRecord.getCount()).isEqualTo(4);
        assertThat(internalRecord.getTemporalType())
                .isEqualTo(SymptomRecord.RECORD_TEMPORAL_TYPE_INTERVAL);
    ...
    @Test
    public void symptomRecord_toInternalRecord_optionalFieldsNotSet() {
        ...
        assertThat(internalRecord.getSeverity()).isEqualTo(SymptomRecord.SEVERITY_UNSPECIFIED);
        assertThat(internalRecord.getCount()).isEqualTo(1);
        assertThat(internalRecord.getTemporalType())
                .isEqualTo(SymptomRecord.RECORD_TEMPORAL_TYPE_INTERVAL);
        assertThat(internalRecord.getStartTimeInMillis()).isEqualTo(1357924680);
        assertThat(internalRecord.getEndTimeInMillis()).isEqualTo(2468013579L);
    ...
    @Test
    public void equals_allFieldsSet_recordsAreEqual() {
        UUID uuid = UUID.randomUUID();
        SymptomRecordInternal record1 =
                (SymptomRecordInternal)
                        new SymptomRecordInternal()
                                .setSymptomType(SYMPTOM_TYPE_COUGH)
                                .setNotes("notes")
        ...
        assertThat(record1.getSymptomType()).isEqualTo(record2.getSymptomType());
        assertThat(record1.getNotes()).isEqualTo(record2.getNotes());
        assertThat(record1.getSeverity()).isEqualTo(record2.getSeverity());
        assertThat(record1.getCount()).isEqualTo(record2.getCount());
        assertThat(record1.getTemporalType()).isEqualTo(record2.getTemporalType());
        assertThat(record1.getStartTimeInMillis()).isEqualTo(record2.getStartTimeInMillis());
        assertThat(record1.getEndTimeInMillis()).isEqualTo(record2.getEndTimeInMillis());
        assertThat(record1.getStartZoneOffsetInSeconds())
                .isEqualTo(record2.getStartZoneOffsetInSeconds());
        assertThat(record1.getEndZoneOffsetInSeconds())
                .isEqualTo(record2.getEndZoneOffsetInSeconds());
        assertThat(record1.getAppInfoId()).isEqualTo(record2.getAppInfoId());
        assertThat(record1.getAppName()).isEqualTo(record2.getAppName());
        assertThat(record1.getClientRecordId()).isEqualTo(record2.getClientRecordId());
        assertThat(record1.getClientRecordVersion()).isEqualTo(record2.getClientRecordVersion());
        assertThat(record1.getDeviceInfoId()).isEqualTo(record2.getDeviceInfoId());
        assertThat(record1.getDeviceType()).isEqualTo(record2.getDeviceType());
        assertThat(record1.getLastModifiedTime()).isEqualTo(record2.getLastModifiedTime());
        assertThat(record1.getManufacturer()).isEqualTo(record2.getManufacturer());
        assertThat(record1.getModel()).isEqualTo(record2.getModel());
        assertThat(record1.getPackageName()).isEqualTo(record2.getPackageName());
        assertThat(record1.getRecordingMethod()).isEqualTo(record2.getRecordingMethod());
        assertThat(record1.getRowId()).isEqualTo(record2.getRowId());
        assertThat(record1.getUuid()).isEqualTo(record2.getUuid());
    }

    @Test
    public void equals_oneFieldDifferent_recordsAreNotEqual() {
        UUID uuid = UUID.randomUUID();
        SymptomRecordInternal record1 =
                (SymptomRecordInternal)
                        new SymptomRecordInternal()
    ...
    @Test
    public void toExternalRecord_differentSymptomType() {
        UUID uuid = UUID.randomUUID();
        SymptomRecordInternal internalRecord =
                (SymptomRecordInternal)
                        new SymptomRecordInternal()
    ...
    @Test
    public void toExternalRecord_differentSeverity() {
        UUID uuid = UUID.randomUUID();
        SymptomRecordInternal internalRecord =
                (SymptomRecordInternal)
                        new SymptomRecordInternal()
        ...
        assertThat(externalRecord.getSeverity()).isEqualTo(SymptomRecord.SEVERITY_SEVERE);
    }
}
