...
public class AlcoholConsumptionInternalTest {
    ...
    public void toExternalRecord_allFieldsSet() {
        ...
        assertThat(externalRecord.getEndZoneOffset()).isEqualTo(ZoneOffset.ofHours(-2));
        ...
        assertThat(metadata.getRecordingMethod()).isEqualTo(RECORDING_METHOD_MANUAL_ENTRY);
    }
    ...
    public void writeToParcel_populateUsing_allFieldsSet() {
        ...
        AlcoholConsumptionRecordInternal decodedRecord =
                new AlcoholConsumptionRecordInternal(parcel);
        parcel.recycle();
        ...
        assertThat(decodedRecord.getEndZoneOffsetInSeconds()).isEqualTo(-2 * 3600);
    ...
    @Test
    public void alcoholConsumptionRecord_toInternalRecord_allFieldsSet() {
        UUID uuid = UUID.randomUUID();
        Metadata metadata =
        ...
        assertThat(internalRecord.getEndZoneOffsetInSeconds()).isEqualTo(-2 * 3600);
