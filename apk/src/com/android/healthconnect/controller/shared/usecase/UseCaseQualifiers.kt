...
@Qualifier @Retention(AnnotationRetention.BINARY) annotation class LoadPriorityListUseCase

@Qualifier @Retention(AnnotationRetention.BINARY) annotation class LoadPotentialPriorityListUseCase
