...
/** Formatter for printing BodyTemperatureRecord data. */
@Singleton
...
constructor(
...
) : EntryFormatter<BodyTemperatureRecord>(context, timeFormatter, unitPreferences) {

    override suspend fun formatValue(record: BodyTemperatureRecord): String {
    ...
    override suspend fun formatA11yValue(record: BodyTemperatureRecord): String {
