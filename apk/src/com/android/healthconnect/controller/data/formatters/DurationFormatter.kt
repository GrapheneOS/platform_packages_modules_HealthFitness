...
object DurationFormatter {
    ...
    fun formatDurationLong(context: Context, duration: Duration): String {
        ...
        val hourString: String =
            MessageFormat.format(
                context.getString(R.string.hour_duration_accessibility),
                mapOf("count" to hours),
            )
        ...
        if (hours > 0 && minutes > 0) { // Shows as: N hour(s) N minute(s)
            return context.getString(
                R.string.hour_minute_duration_accessibility,
                hourString,
                minuteString,
            )
        }
    ...
    fun formatDurationDaysOrHours(context: Context, duration: Duration): String {
        ...
        val dayString: String =
            MessageFormat.format(
                context.getString(R.string.day_duration_accessibility),
                mapOf("count" to days),
            )
        val hourString: String =
            MessageFormat.format(
