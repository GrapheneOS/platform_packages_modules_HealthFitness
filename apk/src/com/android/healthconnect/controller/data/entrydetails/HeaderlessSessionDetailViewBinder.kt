...
class HeaderlessSessionDetailViewBinder : SimpleViewBinder<FormattedHeaderlessSessionDetail, View> {
    ...
    override fun bind(view: View, data: FormattedHeaderlessSessionDetail, index: Int) {
