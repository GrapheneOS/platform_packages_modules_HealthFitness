...
enum class PageName(val impressionId: Int, val interactionId: Int) {
    ...
    NEW_HOME_PAGE(
        HEALTH_CONNECT_UI_IMPRESSION__PAGE__NEW_HOME_PAGE,
        HEALTH_CONNECT_UI_INTERACTION__PAGE__NEW_HOME_PAGE,
    ),
    ONBOARDING_PAGE(
    ...
    COMBINED_ALL_DATA_PAGE(
        HEALTH_CONNECT_UI_IMPRESSION__PAGE__COMBINED_ALL_DATA_PAGE,
        HEALTH_CONNECT_UI_INTERACTION__PAGE__COMBINED_ALL_DATA_PAGE,
    ),
    ...
    PRETTY_FHIR_PAGE(
        HEALTH_CONNECT_UI_IMPRESSION__PAGE__PRETTY_FHIR_PAGE,
        HEALTH_CONNECT_UI_INTERACTION__PAGE__PRETTY_FHIR_PAGE,
    ),
    ...
    // New Onboarding
    CONNECT_TWO_APPS_ONBOARDING_PAGE(
        HEALTH_CONNECT_UI_IMPRESSION__PAGE__CONNECT_TWO_APPS_ONBOARDING_PAGE,
        HEALTH_CONNECT_UI_INTERACTION__PAGE__CONNECT_TWO_APPS_ONBOARDING_PAGE,
    ),
    CONNECT_ONE_APP_ONBOARDING_PAGE(
        HEALTH_CONNECT_UI_IMPRESSION__PAGE__CONNECT_ONE_APP_ONBOARDING_PAGE,
        HEALTH_CONNECT_UI_INTERACTION__PAGE__CONNECT_ONE_APP_ONBOARDING_PAGE,
    ),
    ALMOST_DONE_PAGE(
        HEALTH_CONNECT_UI_IMPRESSION__PAGE__ALMOST_DONE_PAGE,
        HEALTH_CONNECT_UI_INTERACTION__PAGE__ALMOST_DONE_PAGE,
    ),
    FITNESS_APP_ONBOARDING_PAGE(
        HEALTH_CONNECT_UI_IMPRESSION__PAGE__FITNESS_APP_ONBOARDING_PAGE,
        HEALTH_CONNECT_UI_INTERACTION__PAGE__FITNESS_APP_ONBOARDING_PAGE,
    ),
    MATCHMAKING_PAGE(
        HEALTH_CONNECT_UI_IMPRESSION__PAGE__MATCHMAKING_PAGE,
        HEALTH_CONNECT_UI_INTERACTION__PAGE__MATCHMAKING_PAGE,
    ),
    UNKNOWN_PAGE(
...
/** Loggable elements in the Matchmaking page. */
enum class MatchmakingElement(override val impressionId: Int, override val interactionId: Int) :
    ElementName {
    MATCHMAKING_EXPANDABLE_PREFERENCE(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__EXPANDABLE_PREFERENCE,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__EXPANDABLE_PREFERENCE,
    ),
    MATCHMAKING_SCREEN_HEADER(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MATCHMAKING_SCREEN_HEADER,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MATCHMAKING_SCREEN_HEADER,
    ),
    MATCHMAKING_SCREEN_HEADER_ICON_VIEW(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MATCHMAKING_SCREEN_HEADER_ICON_VIEW,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MATCHMAKING_SCREEN_HEADER_ICON_VIEW,
    ),
    MATCHMAKING_SCREEN_FOOTER(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MATCHMAKING_SCREEN_FOOTER,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MATCHMAKING_SCREEN_FOOTER,
    ),
    MATCHMAKING_SCREEN_FOOTER_LINK(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MATCHMAKING_SCREEN_FOOTER_LINK,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MATCHMAKING_SCREEN_FOOTER_LINK,
    ),
    MATCHMAKING_DEVICE_PREFERENCE(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MATCHMAKING_DEVICE_PREFERENCE,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MATCHMAKING_DEVICE_PREFERENCE,
    ),
}
...
enum class HomePageElement(override val impressionId: Int, override val interactionId: Int) :
    ...
    NATIVE_STEPS_BANNER(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NATIVE_STEPS_BANNER,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NATIVE_STEPS_BANNER,
    ),
    NATIVE_STEPS_BANNER_DISMISS_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NATIVE_STEPS_BANNER_DISMISS_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NATIVE_STEPS_BANNER_DISMISS_BUTTON,
    ),
    NATIVE_STEPS_BANNER_REVIEW_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NATIVE_STEPS_BANNER_REVIEW_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NATIVE_STEPS_BANNER_REVIEW_BUTTON,
    ),
    ZERO_APPS_CONNECTED_BANNER(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ZERO_APPS_CONNECTED_BANNER,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ZERO_APPS_CONNECTED_BANNER,
    ),
    ZERO_APPS_CONNECTED_BANNER_DISMISS_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ZERO_APPS_CONNECTED_BANNER_DISMISS_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ZERO_APPS_CONNECTED_BANNER_DISMISS_BUTTON,
    ),
    ZERO_APPS_CONNECTED_BANNER_SET_UP_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ZERO_APPS_CONNECTED_BANNER_SET_UP_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ZERO_APPS_CONNECTED_BANNER_SET_UP_BUTTON,
    ),
    ONE_APP_CONNECTED_BANNER(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ONE_APP_CONNECTED_BANNER,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ONE_APP_CONNECTED_BANNER,
    ),
    ONE_APP_CONNECTED_BANNER_DISMISS_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ONE_APP_CONNECTED_BANNER_DISMISS_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ONE_APP_CONNECTED_BANNER_DISMISS_BUTTON,
    ),
    ONE_APP_CONNECTED_BANNER_SET_UP_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ONE_APP_CONNECTED_BANNER_SET_UP_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ONE_APP_CONNECTED_BANNER_SET_UP_BUTTON,
    ),
}

enum class NewHomePageElement(override val impressionId: Int, override val interactionId: Int) :
    ElementName {
    CONNECTED_APP_HOME_SCREEN_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__CONNECTED_APP_HOME_SCREEN_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__CONNECTED_APP_HOME_SCREEN_BUTTON,
    ),
    NOT_CONNECTED_APP_HOME_SCREEN_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NOT_CONNECTED_APP_HOME_SCREEN_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NOT_CONNECTED_APP_HOME_SCREEN_BUTTON,
    ),
    SEE_ALL_CONNECTED_APPS_HOME_SCREEN_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__SEE_ALL_CONNECTED_APPS_HOME_SCREEN_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__SEE_ALL_CONNECTED_APPS_HOME_SCREEN_BUTTON,
    ),
    NO_APPS_AVAILABLE_HEADER(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NO_APPS_AVAILABLE_HEADER,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NO_APPS_AVAILABLE_HEADER,
    ),
    NO_APPS_AVAILABLE_LINK(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NO_APPS_AVAILABLE_LINK,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NO_APPS_AVAILABLE_LINK,
    ),
    DATA_AND_ACCESS_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__DATA_AND_ACCESS_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__DATA_AND_ACCESS_BUTTON,
    ),
    RECENT_ACCESS_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__RECENT_ACCESS_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__RECENT_ACCESS_BUTTON,
    ),
    DEVICES_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__DEVICES_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__DEVICES_BUTTON,
    ),
    MANAGE_DATA_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MANAGE_DATA_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MANAGE_DATA_BUTTON,
    ...
    HOME_PAGE_FOOTER(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__HOME_SCREEN_FOOTER,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__HOME_SCREEN_FOOTER,
    ),
    HOME_PAGE_FOOTER_LINK(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__HOME_SCREEN_FOOTER_LINK,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__HOME_SCREEN_FOOTER_LINK,
    ),
}
...
enum class ToolbarElement(override val impressionId: Int, override val interactionId: Int) :
    ...
    TOOLBAR_ENTER_EMPTY_STATE_SHOW_SYSTEM_MENU(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ENTER_EMPTY_STATE_SHOW_SYSTEM_MENU,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ENTER_EMPTY_STATE_SHOW_SYSTEM_MENU,
    ),
    TOOLBAR_ENTER_EMPTY_STATE_HIDE_SYSTEM_MENU(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ENTER_EMPTY_STATE_HIDE_SYSTEM_MENU,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ENTER_EMPTY_STATE_HIDE_SYSTEM_MENU,
    ),
    TOOLBAR_ENTER_EXISTING_APPS_STATE_SHOW_SYSTEM_MENU(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ENTER_EXISTING_APPS_STATE_SHOW_SYSTEM_MENU,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ENTER_EXISTING_APPS_STATE_SHOW_SYSTEM_MENU,
    ),
    TOOLBAR_ENTER_EXISTING_APPS_STATE_HIDE_SYSTEM_MENU(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ENTER_EXISTING_APPS_STATE_HIDE_SYSTEM_MENU,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ENTER_EXISTING_APPS_STATE_HIDE_SYSTEM_MENU,
    ),
}
...
enum class AllDataElement(override val impressionId: Int, override val interactionId: Int) :
    ...
    MEDICAL_RECORDS_HEADER(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MEDICAL_RECORDS_HEADER,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MEDICAL_RECORDS_HEADER,
    ),
    MEDICAL_RECORDS_HEADER_LINK(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MEDICAL_RECORDS_HEADER_LINK,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MEDICAL_RECORDS_HEADER_LINK,
    ),
}
...
/** Loggable elements belonging to the PrettyFhirPage. */
enum class PrettyFhirPageElement(override val impressionId: Int, override val interactionId: Int) :
    ElementName {
    PRETTY_FHIR_VIEW_SOURCE_DATA_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__PRETTY_FHIR_VIEW_SOURCE_DATA_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__PRETTY_FHIR_VIEW_SOURCE_DATA_BUTTON,
    ),
    PRETTY_FHIR_HEADER_CONTAINER(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__PRETTY_FHIR_HEADER_CONTAINER,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__PRETTY_FHIR_HEADER_CONTAINER,
    ),
    PRETTY_FHIR_GROUP_CONTAINER(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__PRETTY_FHIR_GROUP_CONTAINER,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__PRETTY_FHIR_GROUP_CONTAINER,
    ),
}
...
enum class CommonOnboardingPageElement(
    override val impressionId: Int,
    override val interactionId: Int,
) : ElementName {
    MORE_ABOUT_HEALTH_CONNECT_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MORE_ABOUT_HEALTH_CONNECT_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MORE_ABOUT_HEALTH_CONNECT_BUTTON,
    ),
    APP_WITH_ONBOARDING_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__APP_WITH_ONBOARDING_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__APP_WITH_ONBOARDING_BUTTON,
    ),
    APP_WITHOUT_ONBOARDING_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__APP_WITHOUT_ONBOARDING_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__APP_WITHOUT_ONBOARDING_BUTTON,
    ),
}

enum class ConnectTwoAppsOnboardingPageElement(
    override val impressionId: Int,
    override val interactionId: Int,
) : ElementName {
    CONNECT_FIRST_TWO_APPS_ONBOARDING_SET_UP_LATER_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__CONNECT_FIRST_TWO_APPS_ONBOARDING_SET_UP_LATER_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__CONNECT_FIRST_TWO_APPS_ONBOARDING_SET_UP_LATER_BUTTON,
    )
}

enum class ConnectSecondAddOnboardingPageElement(
    override val impressionId: Int,
    override val interactionId: Int,
) : ElementName {
...
enum class AlmostDonePageElement(override val impressionId: Int, override val interactionId: Int) :
    ElementName {
    ONBOARDING_APP_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ONBOARDING_APP_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ONBOARDING_APP_BUTTON,
    ),
    ONBOARDING_DONE_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__ONBOARDING_DONE_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__ONBOARDING_DONE_BUTTON,
    ),
}

enum class FitnessAppOnboardingPageElement(
    override val impressionId: Int,
    override val interactionId: Int,
) : ElementName {
    FITNESS_APP_ONBOARDING_BACK_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__FITNESS_APP_ONBOARDING_BACK_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__FITNESS_APP_ONBOARDING_BACK_BUTTON,
    ),
    FITNESS_APP_ONBOARDING_DONE_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__FITNESS_APP_ONBOARDING_DONE_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__FITNESS_APP_ONBOARDING_DONE_BUTTON,
    ),
    FITNESS_APP_ONBOARDING_ALLOW_ALL_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__FITNESS_APP_ONBOARDING_ALLOW_ALL_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__FITNESS_APP_ONBOARDING_ALLOW_ALL_BUTTON,
    ),
    FITNESS_APP_ONBOARDING_PERMISSION_BUTTON(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__FITNESS_APP_ONBOARDING_PERMISSION_BUTTON,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__FITNESS_APP_ONBOARDING_PERMISSION_BUTTON,
    ),
    FITNESS_APP_ONBOARDING_LEARN_MORE_LINK(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__FITNESS_APP_ONBOARDING_LEARN_MORE_LINK,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__FITNESS_APP_ONBOARDING_LEARN_MORE_LINK,
    ),
    FITNESS_APP_ONBOARDING_PRIVACY_POLICY_LINK(
        HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__FITNESS_APP_ONBOARDING_PRIVACY_POLICY_LINK,
        HEALTH_CONNECT_UI_INTERACTION__ELEMENT__FITNESS_APP_ONBOARDING_PRIVACY_POLICY_LINK,
    ),
}
