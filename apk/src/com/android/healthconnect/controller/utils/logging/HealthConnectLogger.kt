...
enum class AppPermissionsElement(override val impressionId: Int, override val interactionId: Int) : ElementName {
    SEARCH_BUTTON(
...
enum class AppAccessElement(override val impressionId: Int, override val interactionId: Int) : ElementName {
