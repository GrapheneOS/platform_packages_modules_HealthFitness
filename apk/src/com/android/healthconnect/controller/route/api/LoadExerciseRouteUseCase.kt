...
) : BaseUseCase<String, ExerciseSessionRecord?>(dispatcher), ILoadExerciseRouteUseCase {
...
interface ILoadExerciseRouteUseCase : UseCaseContract<String, ExerciseSessionRecord?>
