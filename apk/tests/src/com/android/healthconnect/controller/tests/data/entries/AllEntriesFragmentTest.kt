...
class AllEntriesFragmentTest {
    ...
    fun showsDateNavigationPreference() {
        ...
        launchNestedEntriesFragment(FitnessPermissionType.STEPS.name).use {
    ...
    fun medicalData_logsMedicalPageImpression() {
        ...
        launchNestedEntriesFragment(MedicalPermissionType.VACCINES.name).use {
    ...
    fun withSleepData_showsListOfEntries() {
        ...
        launchNestedEntriesFragment(SLEEP.name).use {
    ...
    fun withHeartRateData_showsListOfEntries() {
        ...
        launchNestedEntriesFragment(HEART_RATE.name).use {
            onView(withText("7:06 - 7:06")).check(matches(isDisplayed()))
    ...
    fun withExerciseData_showsListOfEntries() {
        ...
        launchNestedEntriesFragment(EXERCISE.name).use {
            onView(withText("7:06 - 7:06")).check(matches(isDisplayed()))
    ...
    fun withPlannedExerciseData_showsListOfEntries() {
        ...
        launchNestedEntriesFragment(PLANNED_EXERCISE.name).use {
            onView(withText("7:06 - 7:06")).check(matches(isDisplayed()))
    ...
    fun withAlcoholConsumptionData_showsListOfEntries() {
        ...
        launchNestedEntriesFragment(FitnessPermissionType.ALCOHOL_CONSUMPTION.name).use {
            onView(withText("7:06 - 7:06")).check(matches(isDisplayed()))
    ...
    fun withSymptomsData_showsListOfEntries() {
        ...
        launchNestedEntriesFragment(FitnessPermissionType.SYMPTOM_COUGH.name).use {
            onView(withText("7:06 - 7:06")).check(matches(isDisplayed()))
    ...
    fun showsData_onOrientationChange() {
        ...
        launchNestedEntriesFragment(FitnessPermissionType.STEPS.name).use { scenario ->
            onView(withText("7:06 - 7:06")).check(matches(isDisplayed()))
            onView(withText("12 steps")).check(matches(isDisplayed()))
            onView(withText("8:06 - 8:06")).check(matches(isDisplayed()))
            onView(withText("15 steps")).check(matches(isDisplayed()))
    ...
    fun clickOnMedicalPermission_navigateToRawFhir() {
        ...
        launchNestedEntriesFragmentWithNavigation(MedicalPermissionType.VACCINES.name).use {
    ...
    private fun launchNestedEntriesFragment(
        permissionName: String
    ): ActivityScenario<TestActivity> {
        return launchNestedFragment<AllEntriesFragment>(
            Bundle().apply { putString(PERMISSION_TYPE_NAME_KEY, permissionName) }
        )
    }

    private fun launchNestedEntriesFragmentWithNavigation(
        permissionName: String
    ): ActivityScenario<TestActivity> {
        return launchNestedFragment<AllEntriesFragment>(
            Bundle().apply { putString(PERMISSION_TYPE_NAME_KEY, permissionName) }
