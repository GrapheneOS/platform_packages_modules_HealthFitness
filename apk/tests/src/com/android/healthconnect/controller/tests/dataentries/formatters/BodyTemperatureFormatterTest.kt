...
import android.healthconnect.datatypes.BodyTemperatureMeasurementLocation.MEASUREMENT_LOCATION_ARMPIT
import android.healthconnect.datatypes.BodyTemperatureMeasurementLocation.MEASUREMENT_LOCATION_EAR
import android.healthconnect.datatypes.BodyTemperatureMeasurementLocation.MEASUREMENT_LOCATION_FINGER
import android.healthconnect.datatypes.BodyTemperatureMeasurementLocation.MEASUREMENT_LOCATION_FOREHEAD
import android.healthconnect.datatypes.BodyTemperatureMeasurementLocation.MEASUREMENT_LOCATION_MOUTH
import android.healthconnect.datatypes.BodyTemperatureMeasurementLocation.MEASUREMENT_LOCATION_RECTUM
import android.healthconnect.datatypes.BodyTemperatureMeasurementLocation.MEASUREMENT_LOCATION_TEMPORAL_ARTERY
import android.healthconnect.datatypes.BodyTemperatureMeasurementLocation.MEASUREMENT_LOCATION_TOE
import android.healthconnect.datatypes.BodyTemperatureMeasurementLocation.MEASUREMENT_LOCATION_UNKNOWN
import android.healthconnect.datatypes.BodyTemperatureMeasurementLocation.MEASUREMENT_LOCATION_VAGINA
import android.healthconnect.datatypes.BodyTemperatureMeasurementLocation.MEASUREMENT_LOCATION_WRIST
...
class BodyTemperatureFormatterTest {
    ...
    @Inject lateinit var formatter: BodyTemperatureFormatter
    ...
    private fun getRecord(location: Int, temp: Double): BodyTemperatureRecord {
