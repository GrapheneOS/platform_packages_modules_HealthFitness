...
public abstract class HealthConnectInjector {
    ...
    /**
     * Getter for {@link DataGranularityStatsLogger} instance initialised by the Health Connect
     * Injector.
     */
    public abstract DataGranularityStatsLogger getDataGranularityStatsLogger();
    ...
    /**
     * Getter for {@link DataQualityTelemetryJobScheduler} instance initialised by the Health
     * Connect Injector.
     */
    public abstract DataQualityTelemetryJobScheduler getDataQualityTelemetryJobScheduler();

    /**
     * Getter for {@link CompletenessStatsCollector} instance initialised by the Health Connect
     * Injector.
     */
    public abstract CompletenessStatsCollector getCompletenessStatsCollector();
