...
public class HealthConnectManagerService extends SystemService {
    ...
    HealthConnectManagerService(Context context, HealthConnectInjector healthConnectInjector) {
        ...
        mHealthConnectService =
                new HealthConnectServiceImpl(
                        ...
                        mHealthConnectInjector.getFitnessRecordAggregateHelper(),
                        ...
                        mHealthConnectInjector.getRecordDateHelper(),
    ...
    private void setupForCurrentForegroundUser() {
        ...
        TelemetryJobService.setupForUser(mCurrentForegroundUser);
        ...
        threadScheduler.scheduleInternalTask(
                () -> {
                    try {
                        mHealthConnectInjector.getDataQualityTelemetryJobScheduler().schedule();
                    } catch (Exception e) {
                    ...
                    () -> {
                        try {
                            OnboardingNotificationJob.scheduleJobIfNotScheduled(
                                    mContext,
                                    mCurrentForegroundUser,
                                    mHealthConnectInjector.getResourcesContext());
                        } catch (Exception e) {
