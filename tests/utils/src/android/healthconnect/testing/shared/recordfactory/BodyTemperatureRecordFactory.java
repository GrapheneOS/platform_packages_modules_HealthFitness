...
public final class BodyTemperatureRecordFactory extends RecordFactory<BodyTemperatureRecord> {
    ...
    @Override
    public BodyTemperatureRecord newFullRecord(Metadata metadata, Instant time, Instant endTime) {
    ...
    @Override
    public BodyTemperatureRecord anotherFullRecord(
    ...
    @Override
    public BodyTemperatureRecord newEmptyRecord(Metadata metadata, Instant time, Instant endTime) {
        return new BodyTemperatureRecord.Builder(
                        metadata,
                        time,
                        BodyTemperatureMeasurementLocation.MEASUREMENT_LOCATION_UNKNOWN,
    ...
    @Override
    protected BodyTemperatureRecord recordWithMetadata(
            BodyTemperatureRecord record, Metadata metadata) {
        return new BodyTemperatureRecord.Builder(
                        metadata,
                        record.getTime(),
    ...
    @Override
    protected Bundle getValuesBundleForRecord(BodyTemperatureRecord record) {
    ...
    @Override
    public BodyTemperatureRecord newRecordFromValuesBundle(
            Metadata metadata,
            Instant time,
            Instant endTime,
