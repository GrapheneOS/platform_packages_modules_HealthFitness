...
public class HeartRateRecordTest {
    ...
    public void testEqualsHashcode() {
        ...
        List<HeartRateRecord.HeartRateSample> oneSample =
                List.of(new HeartRateRecord.HeartRateSample(60, midTime));
        new EqualsTester()
                .addEqualityGroup(
                ...
                .addEqualityGroup(
                        new HeartRateRecord.Builder(
                                        ...
                                        List.of(new HeartRateRecord.HeartRateSample(70L, midTime)))
                                .build(),
                        new HeartRateRecord.Builder(
                                        fullMetadata,
                                        start,
                ...
                .addEqualityGroup(
                        new HeartRateRecord.Builder(
                                        ...
                                        List.of(
                                                ...
                                                new HeartRateRecord.HeartRateSample(80, midTime)))
                                .build(),
                        new HeartRateRecord.Builder(
                                        fullMetadata,
                                        start,
    ...
    public void testSampleEqualsHashcode() {
        ...
        new EqualsTester()
                .addEqualityGroup(
                        new HeartRateRecord.HeartRateSample(60, time2),
                        new HeartRateRecord.HeartRateSample(60, time2))
                .addEqualityGroup(
                        new HeartRateRecord.HeartRateSample(60, time1),
                        new HeartRateRecord.HeartRateSample(60, time1))
                .addEqualityGroup(
                        new HeartRateRecord.HeartRateSample(70, time1),
                        new HeartRateRecord.HeartRateSample(70, time1))
                .testEquals();
    }
}
