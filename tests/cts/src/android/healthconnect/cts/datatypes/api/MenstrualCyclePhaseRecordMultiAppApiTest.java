...
public class MenstrualCyclePhaseRecordMultiAppApiTest
        extends BaseMultiAppApiTest<MenstrualCyclePhaseRecord> {
    public MenstrualCyclePhaseRecordMultiAppApiTest() {
        super(
